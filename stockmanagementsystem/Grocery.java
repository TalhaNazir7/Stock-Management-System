...
public class Grocery extends JFrame{
    ...
    {
        ImageIcon ic=new ImageIcon(getClass().getResource("Grocery.jpeg"));
        ...
        lb1=new JLabel("WELCOME TO GROCERY",JLabel.CENTER);
        ...
        lb5=new JLabel("Meat  Vegetables  Sugar  Rice  Floor  Sweets",JLabel.CENTER);
    ...
    {        
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            {
                if(t1.getText().compareTo("Meat")==0||t1.getText().compareTo("Vegetables")==0
                        ||t1.getText().compareTo("Sugar")==0||t1.getText().compareTo("Rice")==0
                        ||t1.getText().compareTo("Floor")==0||t1.getText().compareTo("Sweets")==0)
                {
                    try
                    {
                    FileWriter f=new FileWriter("Grocery.txt",true);
