...
public class Cutlery extends JFrame{
    private JLabel imglb,lb1,lb2,lb3,lb4,lb5;
    private JTextField t1,t2;
    private JButton b1,b2,b3;
    public void initialize()
    {
        ImageIcon ic=new ImageIcon(getClass().getResource("Cutlery.jpeg"));
        ...
        lb1=new JLabel("WELCOME TO CUTLERY",JLabel.CENTER);
        ...
        lb5=new JLabel("Spoon  Plate  Jug  Glass  Fork  Saucer",JLabel.CENTER);
    ...
    {        
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            {
                if(t1.getText().compareTo("Spoon")==0||t1.getText().compareTo("Plate")==0
                        ||t1.getText().compareTo("Saucer")==0||t1.getText().compareTo("Jug")==0
                        ||t1.getText().compareTo("Glass")==0||t1.getText().compareTo("Fork")==0)
                {
                    try
                    {
                    FileWriter f=new FileWriter("Cutlery.txt",true);
            ...
            else if(btntxt.compareTo("View Record")==0)
            {
               ShowTable ans=new ShowTable();
                ans.initilizer("Cutlery.txt");
            }
            else if(btntxt.compareTo("Delete File")==0)
            {
                try
                {
                    File f=new File("Cutlery.txt");
                    f.delete();
