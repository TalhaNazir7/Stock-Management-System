...
public class Electronics extends JFrame{
    ...
    {
        ImageIcon ic=new ImageIcon(getClass().getResource("Electronics.jpeg"));
        ...
        lb1=new JLabel("WELCOME TO ELECTRONICS",JLabel.CENTER);
        ...
        lb5=new JLabel("Oven  Fridge  TV  Fan  Laptop  Android",JLabel.CENTER);
    ...
    {        
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            {
                if(t1.getText().compareTo("Oven")==0||t1.getText().compareTo("Fridge")==0
                        ||t1.getText().compareTo("TV")==0||t1.getText().compareTo("Fan")==0
                        ||t1.getText().compareTo("Laptop")==0||t1.getText().compareTo("Android")==0)
                {
                    try
                    {
                    FileWriter f=new FileWriter("Electronics.txt",true);
            ...
            else if(btntxt.compareTo("View Record")==0)
            {
                ...
                ans.initilizer("Electronics.txt");
            }
